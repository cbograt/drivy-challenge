...
RSpec.describe Rental do
  ...
  describe '#duration' do
    ...
    context 'when start_date is nil' do
      ...
      include_examples 'invalid duration'
    end
    ...
    it 'should return the right rental duration' do
      expect(subject).to eq(duration)
    end
  end

  describe '#price_for_duration' do
    subject { rental.price_for_duration }

    it 'should return the right price for the rental duration' do
      expect(subject).to eq(duration * car.price_per_day)
    end
  end
